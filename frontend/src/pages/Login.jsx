  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--color-paper)' }}>
      ...
      >
        ...
        <p className="text-sm mb-6" style={{ color: 'var(--color-ink-muted)' }}>Log in to check your resume readiness.</p>
        ...
        <p className="text-sm mt-6 text-center" style={{ color: 'var(--color-ink-muted)' }}>
          ...
          <Link to="/register" className="font-medium" style={{ color: 'var(--color-signal)' }}>
            Sign up
          </Link>
        </p>
      </motion.div>
